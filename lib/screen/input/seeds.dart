      ...
      body: Padding(
        ...
        child: FutureBuilder(
            future: Provider.of<AuthProvider>(context)
                .fetchProductApi(widget.category, widget.subcategory),
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                ...
                                children: [
                                  Text(
                                    snapshots.data['data'][index]['name'],
                                                                ...
                                                                child: ListView
                                                                    .builder(
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          return Visibility(
                                                                            visible:
                                                                                response.data[index].type == farmerType.F,
                                                                            child:
                                                                                GestureDetector(
                                                                              onTap: () async {
